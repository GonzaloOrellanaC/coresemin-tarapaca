...
const Server = () => {
    ...
    app.use('/uploads', (req, res, next) => {
        ...
        next();
    }, (0, cors_1.default)({ origin, credentials: true }), express_1.default.static(path_1.default.join(process.cwd(), 'uploads')));
    app.use('/public', (req, res, next) => {
        res.setHeader('Cross-Origin-Resource-Policy', 'cross-origin');
        next();
    }, (0, cors_1.default)({ origin, credentials: true }), express_1.default.static(path_1.default.join(process.cwd(), 'public')));
    ...
    app.use('/images', (req, res, next) => {
        res.setHeader('Cross-Origin-Resource-Policy', 'cross-origin');
        next();
    }, (0, cors_1.default)({ origin, credentials: true }), express_1.default.static(imagesDir));
